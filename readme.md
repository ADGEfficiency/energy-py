...
This project is built and maintained by Adam Green -  adam.green@adgefficiency.com.  You can read the introductory blog post for this project here (****).

## Guide to the project

energy_py is composed of Python scripts
...
The computational cost of this grows linearly with number of actions.  Currently each asset has two actions per asset.   You can see how the action space is generated by looking at environments.energy_py.create_action_space(last_actions).
